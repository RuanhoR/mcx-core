...
describe('ItemComponent', () => {
  it('should throw on missing format', () => {
    const item = new ItemComponent({
      id: 'test:item', name: 'Test', format: '', components: {},
    });
  ...
  it('should throw on missing id', () => {
    const item = new ItemComponent({
      id: '', name: 'Test', format: '1.21.0', components: {},
    });
  ...
  it('should create valid item JSON', () => {
    const item = new ItemComponent({
      id: 'test:item', name: 'Test Item', format: '1.21.0',
      components: { damage: 5, offHand: true },
    });
...
describe('BlockComponent', () => {
  ...
  it('should create valid block JSON with components', () => {
    const block = new BlockComponent({
      id: 'test:block', format: '1.21.0',
      components: {
        display_name: 'Test Block', light_emission: 12, light_dampening: 15,
        friction: 0.6, destructible_by_explosion: { explosion_resistance: 30 },
        destructible_by_mining: { seconds_to_destroy: 3 },
        flammable: { catch_chance_modifier: 10, destroy_chance_modifier: 15 },
        collision_box: true, selection_box: { origin: [-8, 0, -8], size: [16, 16, 16] },
        ...
        liquid_detection: { can_contain_liquid: true, on_liquid_touches: 'blocking' },
        precipitation_interactions: { precipitation_behavior: 'snowlogging' },
        entity_fall_on: { minimum_fall_distance: 2 },
        replaceable: {}, flower_pottable: {}, chest_obstruction: {},
...
describe('EntityComponent', () => {
  ...
  it('should create valid entity JSON', () => {
    const entity = new EntityComponent({
      id: 'test:entity', format: '1.21.0', is_spawnable: true, is_summonable: true,
    });
...
describe('compareVar', () => {
  it('should return 0 for equal versions', () => { expect(compareVar('1.0.0', '1.0.0')).toBe(0); });
  it('should return 1 when first is greater', () => { expect(compareVar('2.0.0', '1.0.0')).toBe(1); });
  it('should return -1 when first is smaller', () => { expect(compareVar('1.0.0', '2.0.0')).toBe(-1); });
  it('should handle partial versions', () => { expect(compareVar('1', '2')).toBe(-1); });
...
describe('RecipeComponent', () => {
  it('should create shaped recipe JSON', () => {
    const recipe = new RecipeComponent({
      format: '1.20.0', id: 'test:iron_sword', type: 'shaped', tags: ['crafting_table'],
      pattern: ['X', 'X', '#'],
  ...
  it('should create shapeless recipe JSON', () => {
    const recipe = new RecipeComponent({
      format: '1.20.0', id: 'test:blaze_powder', type: 'shapeless', tags: ['crafting_table'],
  ...
  it('should create furnace recipe JSON', () => {
    const recipe = new RecipeComponent({
      format: '1.20.0', id: 'test:smelt_ore', type: 'furnace', tags: ['furnace'],
      input: { item: 'minecraft:iron_ore' }, output: 'minecraft:iron_ingot',
    });
    const json = recipe.toJSON() as Record<string, unknown>;
  ...
  it('should create smithing_transform recipe JSON', () => {
    const recipe = new RecipeComponent({
      format: '1.20.0', id: 'test:netherite_boots', type: 'smithing_transform', tags: ['smithing_table'],
      template: 'minecraft:netherite_upgrade_smithing_template', base: 'minecraft:diamond_boots',
      addition: 'minecraft:netherite_ingot', result: 'minecraft:netherite_boots',
    });
    const json = recipe.toJSON() as Record<string, unknown>;
  ...
  it('should create smithing_trim recipe JSON', () => {
    const recipe = new RecipeComponent({
      format: '1.20.0', id: 'test:trim', type: 'smithing_trim', tags: ['smithing_table'],
      template: 'minecraft:jungle_temple_smithing_template', base: 'minecraft:diamond_boots',
  ...
  it('should create brewing_container recipe JSON', () => {
    const recipe = new RecipeComponent({
      format: '1.20.0', id: 'test:brew_splash', type: 'brewing_container', tags: ['brewing_stand'],
  ...
  it('should create brewing_mix recipe JSON', () => {
    const recipe = new RecipeComponent({
      format: '1.20.0', id: 'test:brew_strength', type: 'brewing_mix', tags: ['brewing_stand'],
      input: 'minecraft:potion_type:awkward', reagent: 'minecraft:blaze_powder',
  ...
  it('should use getters/setters', () => {
    const recipe = new RecipeComponent({ format: '1.20.0', id: 'test:recipe', type: 'shaped' });
  ...
  it('should default format_version for smithing recipes', () => {
    const recipe = new RecipeComponent({
      format: '', id: 'test:smith', type: 'smithing_transform', tags: ['smithing_table'],
      template: 'minecraft:template', base: 'minecraft:diamond_chestplate',
      addition: 'minecraft:netherite_ingot', result: 'minecraft:netherite_chestplate',
    });
