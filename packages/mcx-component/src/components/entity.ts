...
class EntityComponent {
    ...
    if (this.#opt.components) {
      ...
      if (hasComponents) {
        ...
        if (movementConfig !== void 0) {
          const moveConfig: Record<string, unknown> = {};
        ...
        if (amphibiousConfig !== void 0) {
          const amphibConfig: Record<string, unknown> = {};
        ...
        if (flyConfig !== void 0) {
          const flyMovementConfig: Record<string, unknown> = {};
        ...
        if (genericConfig !== void 0) {
          const genericMovementConfig: Record<string, unknown> = {};
        ...
        if (glideConfig !== void 0) {
          const glideMovementConfig: Record<string, unknown> = {};
        ...
        if (hoverConfig !== void 0) {
          const hoverMovementConfig: Record<string, unknown> = {};
        ...
        if (jumpConfig !== void 0) {
          const jumpMovementConfig: Record<string, unknown> = {};
        ...
        if (skipConfig !== void 0) {
          const skipMovementConfig: Record<string, unknown> = {};
        ...
        if (soundDistanceOffsetConfig !== void 0) {
          const soundDistanceOffsetMovementConfig: Record<string, unknown> = {};
        ...
        if (swayConfig !== void 0) {
          const swayMovementConfig: Record<string, unknown> = {};
        ...
        if (nameableConfig !== void 0) {
          const nameableConfigObj: Record<string, unknown> = {};
          if (
        ...
        if (navigationClimbConfig !== void 0) {
          const navigationClimbConfigObj: Record<string, unknown> = {};
        ...
        if (navigationFloatConfig !== void 0) {
          const navigationFloatConfigObj: Record<string, unknown> = {};
        ...
        if (navigationFlyConfig !== void 0) {
          const navigationFlyConfigObj: Record<string, unknown> = {};
        ...
        if (navigationGenericConfig !== void 0) {
          const navigationGenericConfigObj: Record<string, unknown> = {};
        ...
        if (navigationHoverConfig !== void 0) {
          const navigationHoverConfigObj: Record<string, unknown> = {};
        ...
        if (navigationSwimConfig !== void 0) {
          const navigationSwimConfigObj: Record<string, unknown> = {};
        ...
        if (navigationWalkConfig !== void 0) {
          const navigationWalkConfigObj: Record<string, unknown> = {};
        ...
        if (preferredPathConfig !== void 0) {
          const preferredPathConfigObj: Record<string, unknown> = {};
        ...
        if (offspringConfig !== void 0) {
          const offspringConfigObj: Record<string, unknown> = {};
          ...
          if (offspringConfig.mutation_factor !== void 0) {
            const mutationFactorObj: Record<string, unknown> = {};
          ...
          if (offspringConfig.inheritance_chance !== void 0) {
            const inheritanceChanceObj: Record<string, unknown> = {};
          ...
          if (offspringConfig.parent_centric_attribute_blending !== void 0) {
            const attributeBlendingObj: Record<string, unknown> = {};
            if (
  ...
  #validateDamageSensorTrigger(trigger: {
    cause?: string;
    damage_modifier?: number;
    damage_multiplier?: number;
    deals_damage?: boolean | string;
  ...
  public setFlocking(
    ...
    const validateNumber = (value: unknown, name: string): void => {
      if (value !== void 0 && typeof value !== 'number') {
        throw new TypeError(`[set error]: flocking: ${name} must be a number`);
      }
    };

    const validateInteger = (value: unknown, name: string): void => {
      if (
        value !== void 0 &&
    ...
    const validateBoolean = (value: unknown, name: string): void => {
      ...
      for (let i = 0; i < config.genes.length; i++) {
        ...
        if (gene.genetic_variants !== void 0) {
          ...
          for (let j = 0; j < gene.genetic_variants.length; j++) {
            ...
            const validateAllele = (value: unknown, propName: string): void => {
              if (value !== void 0) {
                if (typeof value === 'number') {
                  ...
                  const obj = value as { range_min: number; range_max: number };
                  if (
                    typeof obj.range_min !== 'number' ||
                    typeof obj.range_max !== 'number' ||
                    !Number.isInteger(obj.range_min) ||
                    !Number.isInteger(obj.range_max) ||
                    obj.range_min < 0 ||
                    obj.range_max < obj.range_min
                  ) {
                    throw new TypeError(
   ...
   */
  public setInputAirControlled(config: Record<string, unknown> = {}): void {
    if (typeof config !== 'object' || config === null) {
      throw new TypeError(
    ...
    if (config.control_items !== void 0) {
      if (
        ...
        (!Array.isArray(config.control_items) ||
          config.control_items.some((item: string) => typeof item !== 'string'))
      ) {
        throw new TypeError(
  ...
  public setLookedAt(
    ...
    if (config.look_at_locations !== void 0) {
      if (
        ...
        config.look_at_locations.some((loc: string) => typeof loc !== 'string')
      ) {
        throw new TypeError(
  ...
  public setOffspring(config: {
    ...
    property_inheritance?: Record<string, unknown>;
