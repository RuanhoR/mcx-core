...
class EntityComponent {
  ...
  public toJSON(): t.EntityJSON {
    ...
    if (this.#opt.components) {
      ...
      const hasComponents =
        ...
        components["minecraft:entity_armor_equipment_slot_mapping"] !== void 0 ||
      ...
      if (hasComponents) {
        ...
        if (itemControllableConfig !== void 0) {
          ApplyComponents["minecraft:item_controllable"] = { ...itemControllableConfig };
        }
        ...
        const managedTraderConfig = components["minecraft:managed_wandering_trader"];
        ...
        if (markVariantConfig !== void 0 && markVariantConfig.value !== void 0) {
          ApplyComponents["minecraft:mark_variant"] = { value: markVariantConfig.value };
        }
        const mobEffectConfig = components["minecraft:mob_effect"];
        if (mobEffectConfig !== void 0 && mobEffectConfig.mob_effect !== void 0) {
          const effectConfig: any = { mob_effect: mobEffectConfig.mob_effect };
          if (mobEffectConfig.ambient !== void 0) effectConfig.ambient = mobEffectConfig.ambient;
          if (mobEffectConfig.cooldown_time !== void 0) effectConfig.cooldown_time = mobEffectConfig.cooldown_time;
          if (mobEffectConfig.effect_range !== void 0) effectConfig.effect_range = mobEffectConfig.effect_range;
          if (mobEffectConfig.effect_time !== void 0) effectConfig.effect_time = mobEffectConfig.effect_time;
          if (mobEffectConfig.entity_filter !== void 0) effectConfig.entity_filter = mobEffectConfig.entity_filter;
          ApplyComponents["minecraft:mob_effect"] = effectConfig;
        }
        const mobImmunityConfig = components["minecraft:mob_effect_immunity"];
        if (mobImmunityConfig !== void 0 && mobImmunityConfig.mob_effects !== void 0) {
          ApplyComponents["minecraft:mob_effect_immunity"] = { mob_effects: mobImmunityConfig.mob_effects };
        }
        ...
        if (movementConfig !== void 0) {
          ...
          if (movementConfig.value !== void 0) moveConfig.value = movementConfig.value;
        ...
        if (amphibiousConfig !== void 0) {
          ...
          if (amphibiousConfig.max_turn !== void 0) amphibConfig.max_turn = amphibiousConfig.max_turn;
        ...
        if (basicMovementConfig !== void 0) {
          ...
          if (basicMovementConfig.max_turn !== void 0) basicConfig.max_turn = basicMovementConfig.max_turn;
        ...
        if (flyConfig !== void 0) {
          ...
          if (flyConfig.max_turn !== void 0) flyMovementConfig.max_turn = flyConfig.max_turn;
          if (flyConfig.speed_when_turning !== void 0) flyMovementConfig.speed_when_turning = flyConfig.speed_when_turning;
          if (flyConfig.start_speed !== void 0) flyMovementConfig.start_speed = flyConfig.start_speed;
        ...
        if (genericConfig !== void 0) {
          ...
          if (genericConfig.max_turn !== void 0) genericMovementConfig.max_turn = genericConfig.max_turn;
        ...
        if (glideConfig !== void 0) {
          ...
          if (glideConfig.max_turn !== void 0) glideMovementConfig.max_turn = glideConfig.max_turn;
          if (glideConfig.speed_when_turning !== void 0) glideMovementConfig.speed_when_turning = glideConfig.speed_when_turning;
        ...
        if (hoverConfig !== void 0) {
          ...
          if (hoverConfig.max_turn !== void 0) hoverMovementConfig.max_turn = hoverConfig.max_turn;
        ...
        if (jumpConfig !== void 0) {
          ...
          if (jumpConfig.jump_delay !== void 0) {
            ...
            } else if (Array.isArray(jumpConfig.jump_delay) && jumpConfig.jump_delay.length === 2) {
              jumpMovementConfig.jump_delay = [...jumpConfig.jump_delay];
            } else if (typeof jumpConfig.jump_delay === "object" && jumpConfig.jump_delay !== null && 'range_min' in jumpConfig.jump_delay) {
              const delayObj = jumpConfig.jump_delay as { range_min?: number, range_max?: number };
              jumpMovementConfig.jump_delay = {
                range_min: delayObj.range_min,
                range_max: delayObj.range_max,
              };
              // 删除void 0属性
              if (jumpMovementConfig.jump_delay.range_min === void 0) delete jumpMovementConfig.jump_delay.range_min;
              if (jumpMovementConfig.jump_delay.range_max === void 0) delete jumpMovementConfig.jump_delay.range_max;
              if (Object.keys(jumpMovementConfig.jump_delay).length === 0) delete jumpMovementConfig.jump_delay;
            }
          }
          if (jumpConfig.max_turn !== void 0) jumpMovementConfig.max_turn = jumpConfig.max_turn;
        ...
        if (skipConfig !== void 0) {
          ...
          if (skipConfig.max_turn !== void 0) skipMovementConfig.max_turn = skipConfig.max_turn;
          ApplyComponents["minecraft:movement.skip"] = skipMovementConfig;
        }
        const soundDistanceOffsetConfig = components["minecraft:movement.sound_distance_offset"];
        if (soundDistanceOffsetConfig !== void 0) {
          const soundDistanceOffsetMovementConfig: any = {};
          if (soundDistanceOffsetConfig.value !== void 0) soundDistanceOffsetMovementConfig.value = soundDistanceOffsetConfig.value;
          ApplyComponents["minecraft:movement.sound_distance_offset"] = soundDistanceOffsetMovementConfig;
        }
        const swayConfig = components["minecraft:movement.sway"];
        if (swayConfig !== void 0) {
          const swayMovementConfig: any = {};
          if (swayConfig.sway_amplitude !== void 0) swayMovementConfig.sway_amplitude = swayConfig.sway_amplitude;
          if (swayConfig.sway_frequency !== void 0) swayMovementConfig.sway_frequency = swayConfig.sway_frequency;
        ...
        if (nameableConfig !== void 0) {
          ...
          if (Array.isArray(nameableConfig.name_actions) && nameableConfig.name_actions.length > 0) {
            nameableConfigObj.name_actions = nameableConfig.name_actions.map(action => {
              const actionObj: any = {};
              if (Array.isArray(action.name_filter) && action.name_filter.length > 0) {
              ...
              if (action.on_named !== void 0) {
                ...
                } else if (typeof action.on_named === "object" && action.on_named !== null) {
                  actionObj.on_named = {
                    event: action.on_named.event,
                  };
                  if (action.on_named.target !== void 0) actionObj.on_named.target = action.on_named.target;
                }
              }
              return actionObj;
            });
        ...
        if (navigationClimbConfig !== void 0) {
          const navigationClimbConfigObj: any = {}; if (navigationClimbConfig.avoid_damage_blocks !== void 0) {
            navigationClimbConfigObj.avoid_damage_blocks = navigationClimbConfig.avoid_damage_blocks;
          }
          if (navigationClimbConfig.avoid_portals !== void 0) {
            navigationClimbConfigObj.avoid_portals = navigationClimbConfig.avoid_portals;
          }
          ...
          if (navigationClimbConfig.avoid_water !== void 0) {
            navigationClimbConfigObj.avoid_water = navigationClimbConfig.avoid_water;
          }
          if (navigationClimbConfig.blocks_to_avoid !== void 0) {
            navigationClimbConfigObj.blocks_to_avoid = [...navigationClimbConfig.blocks_to_avoid];
          }
          if (navigationClimbConfig.can_breach !== void 0) {
            navigationClimbConfigObj.can_breach = navigationClimbConfig.can_breach;
          }
          if (navigationClimbConfig.can_break_doors !== void 0) {
            navigationClimbConfigObj.can_break_doors = navigationClimbConfig.can_break_doors;
          }
          ...
          if (navigationClimbConfig.can_open_doors !== void 0) {
            navigationClimbConfigObj.can_open_doors = navigationClimbConfig.can_open_doors;
          }
          if (navigationClimbConfig.can_open_iron_doors !== void 0) {
            navigationClimbConfigObj.can_open_iron_doors = navigationClimbConfig.can_open_iron_doors;
          }
          if (navigationClimbConfig.can_pass_doors !== void 0) {
            navigationClimbConfigObj.can_pass_doors = navigationClimbConfig.can_pass_doors;
          }
          if (navigationClimbConfig.can_path_from_air !== void 0) {
            navigationClimbConfigObj.can_path_from_air = navigationClimbConfig.can_path_from_air;
          }
          if (navigationClimbConfig.can_path_over_lava !== void 0) {
            navigationClimbConfigObj.can_path_over_lava = navigationClimbConfig.can_path_over_lava;
          }
          if (navigationClimbConfig.can_path_over_water !== void 0) {
            navigationClimbConfigObj.can_path_over_water = navigationClimbConfig.can_path_over_water;
          }
          ...
          if (navigationClimbConfig.can_walk_in_lava !== void 0) {
            navigationClimbConfigObj.can_walk_in_lava = navigationClimbConfig.can_walk_in_lava;
          }
          ApplyComponents["minecraft:navigation.climb"] = navigationClimbConfigObj;
        }
        ...
        if (navigationFloatConfig !== void 0) {
          ...
          if (navigationFloatConfig.avoid_damage_blocks !== void 0) {
            navigationFloatConfigObj.avoid_damage_blocks = navigationFloatConfig.avoid_damage_blocks;
          }
          if (navigationFloatConfig.avoid_portals !== void 0) {
            navigationFloatConfigObj.avoid_portals = navigationFloatConfig.avoid_portals;
          }
          ...
          if (navigationFloatConfig.avoid_water !== void 0) {
            navigationFloatConfigObj.avoid_water = navigationFloatConfig.avoid_water;
          }
          if (navigationFloatConfig.blocks_to_avoid !== void 0) {
            navigationFloatConfigObj.blocks_to_avoid = [...navigationFloatConfig.blocks_to_avoid];
          }
          if (navigationFloatConfig.can_breach !== void 0) {
            navigationFloatConfigObj.can_breach = navigationFloatConfig.can_breach;
          }
          if (navigationFloatConfig.can_break_doors !== void 0) {
            navigationFloatConfigObj.can_break_doors = navigationFloatConfig.can_break_doors;
          }
          ...
          if (navigationFloatConfig.can_open_doors !== void 0) {
            navigationFloatConfigObj.can_open_doors = navigationFloatConfig.can_open_doors;
          }
          if (navigationFloatConfig.can_open_iron_doors !== void 0) {
            navigationFloatConfigObj.can_open_iron_doors = navigationFloatConfig.can_open_iron_doors;
          }
          if (navigationFloatConfig.can_pass_doors !== void 0) {
            navigationFloatConfigObj.can_pass_doors = navigationFloatConfig.can_pass_doors;
          }
          if (navigationFloatConfig.can_path_from_air !== void 0) {
            navigationFloatConfigObj.can_path_from_air = navigationFloatConfig.can_path_from_air;
          }
          if (navigationFloatConfig.can_path_over_water !== void 0) {
            navigationFloatConfigObj.can_path_over_water = navigationFloatConfig.can_path_over_water;
          }
          ...
          if (navigationFloatConfig.can_walk_in_lava !== void 0) {
            navigationFloatConfigObj.can_walk_in_lava = navigationFloatConfig.can_walk_in_lava;
          }
          if (navigationFloatConfig.is_amphibious !== void 0) {
            navigationFloatConfigObj.is_amphibious = navigationFloatConfig.is_amphibious;
          }
          if (navigationFloatConfig.using_door_annotation !== void 0) {
            navigationFloatConfigObj.using_door_annotation = navigationFloatConfig.using_door_annotation;
          }
          ApplyComponents["minecraft:navigation.float"] = navigationFloatConfigObj;
        }
        ...
        if (navigationFlyConfig !== void 0) {
          ...
          if (navigationFlyConfig.avoid_damage_blocks !== void 0) {
            navigationFlyConfigObj.avoid_damage_blocks = navigationFlyConfig.avoid_damage_blocks;
          }
          if (navigationFlyConfig.avoid_portals !== void 0) {
            navigationFlyConfigObj.avoid_portals = navigationFlyConfig.avoid_portals;
          }
          ...
          if (navigationFlyConfig.blocks_to_avoid !== void 0) {
            navigationFlyConfigObj.blocks_to_avoid = [...navigationFlyConfig.blocks_to_avoid];
          }
          ...
          if (navigationFlyConfig.can_break_doors !== void 0) {
            navigationFlyConfigObj.can_break_doors = navigationFlyConfig.can_break_doors;
          }
          ...
          if (navigationFlyConfig.can_open_doors !== void 0) {
            navigationFlyConfigObj.can_open_doors = navigationFlyConfig.can_open_doors;
          }
          if (navigationFlyConfig.can_open_iron_doors !== void 0) {
            navigationFlyConfigObj.can_open_iron_doors = navigationFlyConfig.can_open_iron_doors;
          }
          if (navigationFlyConfig.can_pass_doors !== void 0) {
            navigationFlyConfigObj.can_pass_doors = navigationFlyConfig.can_pass_doors;
          }
          if (navigationFlyConfig.can_path_from_air !== void 0) {
            navigationFlyConfigObj.can_path_from_air = navigationFlyConfig.can_path_from_air;
          }
          if (navigationFlyConfig.can_path_over_water !== void 0) {
            navigationFlyConfigObj.can_path_over_water = navigationFlyConfig.can_path_over_water;
          }
          ...
          if (navigationFlyConfig.can_walk_in_lava !== void 0) {
            navigationFlyConfigObj.can_walk_in_lava = navigationFlyConfig.can_walk_in_lava;
          }
          if (navigationFlyConfig.is_amphibious !== void 0) {
            navigationFlyConfigObj.is_amphibious = navigationFlyConfig.is_amphibious;
          }
          if (navigationFlyConfig.using_door_annotation !== void 0) {
            navigationFlyConfigObj.using_door_annotation = navigationFlyConfig.using_door_annotation;
          }
          ApplyComponents["minecraft:navigation.fly"] = navigationFlyConfigObj;
        }
        const navigationGenericConfig = components["minecraft:navigation.generic"];
        if (navigationGenericConfig !== void 0) {
          ...
          if (navigationGenericConfig.avoid_damage_blocks !== void 0) {
            navigationGenericConfigObj.avoid_damage_blocks = navigationGenericConfig.avoid_damage_blocks;
          }
          if (navigationGenericConfig.avoid_portals !== void 0) {
            navigationGenericConfigObj.avoid_portals = navigationGenericConfig.avoid_portals;
          }
          if (navigationGenericConfig.avoid_sun !== void 0) {
            navigationGenericConfigObj.avoid_sun = navigationGenericConfig.avoid_sun;
          }
          if (navigationGenericConfig.avoid_water !== void 0) {
            navigationGenericConfigObj.avoid_water = navigationGenericConfig.avoid_water;
          }
          if (navigationGenericConfig.blocks_to_avoid !== void 0) {
            navigationGenericConfigObj.blocks_to_avoid = [...navigationGenericConfig.blocks_to_avoid];
          }
          if (navigationGenericConfig.can_breach !== void 0) {
            navigationGenericConfigObj.can_breach = navigationGenericConfig.can_breach;
          }
          if (navigationGenericConfig.can_break_doors !== void 0) {
            navigationGenericConfigObj.can_break_doors = navigationGenericConfig.can_break_doors;
          }
          if (navigationGenericConfig.can_jump !== void 0) {
            navigationGenericConfigObj.can_jump = navigationGenericConfig.can_jump;
          }
          if (navigationGenericConfig.can_open_doors !== void 0) {
            navigationGenericConfigObj.can_open_doors = navigationGenericConfig.can_open_doors;
          }
          if (navigationGenericConfig.can_open_iron_doors !== void 0) {
            navigationGenericConfigObj.can_open_iron_doors = navigationGenericConfig.can_open_iron_doors;
          }
          if (navigationGenericConfig.can_pass_doors !== void 0) {
            navigationGenericConfigObj.can_pass_doors = navigationGenericConfig.can_pass_doors;
          }
          if (navigationGenericConfig.can_path_from_air !== void 0) {
            navigationGenericConfigObj.can_path_from_air = navigationGenericConfig.can_path_from_air;
          }
          if (navigationGenericConfig.can_path_over_water !== void 0) {
            navigationGenericConfigObj.can_path_over_water = navigationGenericConfig.can_path_over_water;
          }
          if (navigationGenericConfig.can_sink !== void 0) {
            navigationGenericConfigObj.can_sink = navigationGenericConfig.can_sink;
          }
          if (navigationGenericConfig.can_swim !== void 0) {
            navigationGenericConfigObj.can_swim = navigationGenericConfig.can_swim;
          }
          if (navigationGenericConfig.can_walk !== void 0) {
            navigationGenericConfigObj.can_walk = navigationGenericConfig.can_walk;
          }
          if (navigationGenericConfig.can_walk_in_lava !== void 0) {
            navigationGenericConfigObj.can_walk_in_lava = navigationGenericConfig.can_walk_in_lava;
          }
          if (navigationGenericConfig.is_amphibious !== void 0) {
            navigationGenericConfigObj.is_amphibious = navigationGenericConfig.is_amphibious;
          }
          if (navigationGenericConfig.using_door_annotation !== void 0) {
            navigationGenericConfigObj.using_door_annotation = navigationGenericConfig.using_door_annotation;
          }
          ApplyComponents["minecraft:navigation.generic"] = navigationGenericConfigObj;
        }
        ...
        if (navigationHoverConfig !== void 0) {
          ...
          if (hoverConfig.avoid_damage_blocks !== void 0) {
            navigationHoverConfigObj.avoid_damage_blocks = hoverConfig.avoid_damage_blocks;
          }
          if (navigationHoverConfig.avoid_portals !== void 0) {
            navigationHoverConfigObj.avoid_portals = navigationHoverConfig.avoid_portals;
          }
          ...
          if (navigationHoverConfig.avoid_water !== void 0) {
            navigationHoverConfigObj.avoid_water = navigationHoverConfig.avoid_water;
          }
          if (navigationHoverConfig.blocks_to_avoid !== void 0) {
            navigationHoverConfigObj.blocks_to_avoid = [...navigationHoverConfig.blocks_to_avoid];
          }
          if (navigationHoverConfig.can_breach !== void 0) {
            navigationHoverConfigObj.can_breach = navigationHoverConfig.can_breach;
          }
          if (navigationHoverConfig.can_break_doors !== void 0) {
            navigationHoverConfigObj.can_break_doors = navigationHoverConfig.can_break_doors;
          }
          ...
          if (navigationHoverConfig.can_open_doors !== void 0) {
            navigationHoverConfigObj.can_open_doors = navigationHoverConfig.can_open_doors;
          }
          if (navigationHoverConfig.can_open_iron_doors !== void 0) {
            navigationHoverConfigObj.can_open_iron_doors = navigationHoverConfig.can_open_iron_doors;
          }
          if (navigationHoverConfig.can_pass_doors !== void 0) {
            navigationHoverConfigObj.can_pass_doors = navigationHoverConfig.can_pass_doors;
          }
          if (navigationHoverConfig.can_path_from_air !== void 0) {
            navigationHoverConfigObj.can_path_from_air = navigationHoverConfig.can_path_from_air;
          }
          if (navigationHoverConfig.can_path_over_water !== void 0) {
            navigationHoverConfigObj.can_path_over_water = navigationHoverConfig.can_path_over_water;
          }
          ...
          if (navigationHoverConfig.can_walk_in_lava !== void 0) {
            navigationHoverConfigObj.can_walk_in_lava = navigationHoverConfig.can_walk_in_lava;
          }
          if (navigationHoverConfig.is_amphibious !== void 0) {
            navigationHoverConfigObj.is_amphibious = navigationHoverConfig.is_amphibious;
          }
          if (navigationHoverConfig.using_door_annotation !== void 0) {
            navigationHoverConfigObj.using_door_annotation = navigationHoverConfig.using_door_annotation;
          }
          ApplyComponents["minecraft:navigation.hover"] = navigationHoverConfigObj;
        }
        ...
        if (navigationSwimConfig !== void 0) {
          ...
          if (navigationSwimConfig.avoid_damage_blocks !== void 0) {
            navigationSwimConfigObj.avoid_damage_blocks = navigationSwimConfig.avoid_damage_blocks;
          }
          if (navigationSwimConfig.avoid_portals !== void 0) {
            navigationSwimConfigObj.avoid_portals = navigationSwimConfig.avoid_portals;
          }
          ...
          if (navigationSwimConfig.avoid_water !== void 0) {
            navigationSwimConfigObj.avoid_water = navigationSwimConfig.avoid_water;
          }
          ...
          if (navigationSwimConfig.can_break_doors !== void 0) {
            navigationSwimConfigObj.can_break_doors = navigationSwimConfig.can_break_doors;
          }
          ...
          if (navigationSwimConfig.can_open_doors !== void 0) {
            navigationSwimConfigObj.can_open_doors = navigationSwimConfig.can_open_doors;
          }
          if (navigationSwimConfig.can_open_iron_doors !== void 0) {
            navigationSwimConfigObj.can_open_iron_doors = navigationSwimConfig.can_open_iron_doors;
          }
          if (navigationSwimConfig.can_pass_doors !== void 0) {
            navigationSwimConfigObj.can_pass_doors = navigationSwimConfig.can_pass_doors;
          }
          if (navigationSwimConfig.can_path_from_air !== void 0) {
            navigationSwimConfigObj.can_path_from_air = navigationSwimConfig.can_path_from_air;
          }
          if (navigationSwimConfig.can_path_over_water !== void 0) {
            navigationSwimConfigObj.can_path_over_water = navigationSwimConfig.can_path_over_water;
          }
          ...
          if (navigationSwimConfig.can_walk_in_lava !== void 0) {
            navigationSwimConfigObj.can_walk_in_lava = navigationSwimConfig.can_walk_in_lava;
          }
          if (navigationSwimConfig.is_amphibious !== void 0) {
            navigationSwimConfigObj.is_amphibious = navigationSwimConfig.is_amphibious;
          }
          if (navigationSwimConfig.using_door_annotation !== void 0) {
            navigationSwimConfigObj.using_door_annotation = navigationSwimConfig.using_door_annotation;
          }
        ...
        if (navigationWalkConfig !== void 0) {
          ...
          if (navigationWalkConfig.avoid_damage_blocks !== void 0) {
            navigationWalkConfigObj.avoid_damage_blocks = navigationWalkConfig.avoid_damage_blocks;
          }
          if (navigationWalkConfig.avoid_portals !== void 0) {
            navigationWalkConfigObj.avoid_portals = navigationWalkConfig.avoid_portals;
          }
          ...
          if (navigationWalkConfig.avoid_water !== void 0) {
            navigationWalkConfigObj.avoid_water = navigationWalkConfig.avoid_water;
          }
          if (navigationWalkConfig.blocks_to_avoid !== void 0) {
            navigationWalkConfigObj.blocks_to_avoid = [...navigationWalkConfig.blocks_to_avoid].map((item) => {
          ...
          if (navigationWalkConfig.can_break_doors !== void 0) {
            navigationWalkConfigObj.can_break_doors = navigationWalkConfig.can_break_doors;
          }
          ...
          if (navigationWalkConfig.can_open_doors !== void 0) {
            navigationWalkConfigObj.can_open_doors = navigationWalkConfig.can_open_doors;
          }
          if (navigationWalkConfig.can_open_iron_doors !== void 0) {
            navigationWalkConfigObj.can_open_iron_doors = navigationWalkConfig.can_open_iron_doors;
          }
          if (navigationWalkConfig.can_pass_doors !== void 0) {
            navigationWalkConfigObj.can_pass_doors = navigationWalkConfig.can_pass_doors;
          }
          if (navigationWalkConfig.can_path_from_air !== void 0) {
            navigationWalkConfigObj.can_path_from_air = navigationWalkConfig.can_path_from_air;
          }
          if (navigationWalkConfig.can_path_over_water !== void 0) {
            navigationWalkConfigObj.can_path_over_water = navigationWalkConfig.can_path_over_water;
          }
          ...
          if (navigationWalkConfig.can_walk_in_lava !== void 0) {
            navigationWalkConfigObj.can_walk_in_lava = navigationWalkConfig.can_walk_in_lava;
          }
          if (navigationWalkConfig.is_amphibious !== void 0) {
            navigationWalkConfigObj.is_amphibious = navigationWalkConfig.is_amphibious;
          }
        ...
        if (offspringConfig !== void 0) {
          ...
          if (offspringConfig.deny_parents_baby_variant !== void 0) {
            offspringConfigObj.deny_parents_baby_variant = offspringConfig.deny_parents_baby_variant;
          }
          if (offspringConfig.grow_up_duration !== void 0) {
            offspringConfigObj.grow_up_duration = offspringConfig.grow_up_duration;
          }
          ...
          if (offspringConfig.inheritance_chance !== void 0) {
            ...
            if (offspringConfig.inheritance_chance.angry !== void 0) {
              inheritanceChanceObj.angry = offspringConfig.inheritance_chance.angry;
            }
            if (offspringConfig.inheritance_chance.attacker !== void 0) {
              inheritanceChanceObj.attacker = offspringConfig.inheritance_chance.attacker;
            }
            if (offspringConfig.inheritance_chance.color !== void 0) {
              inheritanceChanceObj.color = offspringConfig.inheritance_chance.color;
            }
            if (offspringConfig.inheritance_chance.gene !== void 0) {
              inheritanceChanceObj.gene = offspringConfig.inheritance_chance.gene;
            }
            if (offspringConfig.inheritance_chance.variant !== void 0) {
              inheritanceChanceObj.variant = offspringConfig.inheritance_chance.variant;
            }
          ...
          if (offspringConfig.parent_centric_attribute_blending !== void 0) {
            ...
            if (offspringConfig.parent_centric_attribute_blending.attribute !== void 0) {
              attributeBlendingObj.attribute = offspringConfig.parent_centric_attribute_blending.attribute;
            }
            if (offspringConfig.parent_centric_attribute_blending.dampening !== void 0) {
              attributeBlendingObj.dampening = offspringConfig.parent_centric_attribute_blending.dampening;
            }
            if (Object.keys(attributeBlendingObj).length > 0) {
              offspringConfigObj.parent_centric_attribute_blending = attributeBlendingObj;
            }
          }
          if (offspringConfig.should_baby_face_parent !== void 0) {
            offspringConfigObj.should_baby_face_parent = offspringConfig.should_baby_face_parent;
          }
  ...
  public setAdmireItem(config: {
    ...
    if (config.cooldown_after_being_attacked !== void 0 && typeof config.cooldown_after_being_attacked !== "number") {
  ...
  public setAngerLevel(config: {
    ...
    if (config.anger_decrement_interval !== void 0 && typeof config.anger_decrement_interval !== "number") {
      throw new TypeError("[set error]: anger_level: anger_decrement_interval must be a number");
    }
    if (config.angry_boost !== void 0 && (typeof config.angry_boost !== "number" || config.angry_boost < 0)) {
      throw new TypeError("[set error]: anger_level: angry_boost must be a number >= 0");
    }
    if (config.angry_threshold !== void 0 && (typeof config.angry_threshold !== "number" || config.angry_threshold < 0)) {
      throw new TypeError("[set error]: anger_level: angry_threshold must be a number >= 0");
    }
    if (config.max_anger !== void 0 && (typeof config.max_anger !== "number" || config.max_anger < 0)) {
      throw new TypeError("[set error]: anger_level: max_anger must be a number >= 0");
    }
    if (config.broadcast_range !== void 0 && (typeof config.broadcast_range !== "number" || config.broadcast_range < 0)) {
      throw new TypeError("[set error]: anger_level: broadcast_range must be a number >= 0");
    }
    if (config.broadcast_targets !== void 0 && !Array.isArray(config.broadcast_targets)) {
  ...
  public setAngry(config: {
    ...
    if (config.duration_delta !== void 0 && typeof config.duration_delta !== "number") {
  ...
  public setAnnotationBreakDoor(config: {
    ...
    if (config.break_time !== void 0 && (typeof config.break_time !== "number" || config.break_time < 0)) {
      throw new TypeError("[set error]: annotation.break_door: break_time must be a number >= 0");
    }
    if (config.min_difficulty !== void 0 && !['hard', 'normal', 'easy', 'peaceful'].includes(config.min_difficulty)) {
  ...
  public setAttack(config: {
    ...
    if (config.effect_duration !== void 0 && typeof config.effect_duration !== "number") {
  ...
  public setAreaAttack(config: {
    ...
    if (config.damage_cooldown !== void 0 &&
    ...
    if (config.damage_per_tick !== void 0 &&
    ...
    if (config.play_attack_sound !== void 0 && typeof config.play_attack_sound !== "boolean") {
  ...
  public setBalloonable(config: {
    ...
    if (config.max_distance !== void 0 && (typeof config.max_distance !== "number" || config.max_distance < 0)) {
      throw new TypeError("[set error]: balloonable: max_distance must be a number >= 0");
    }
    if (config.soft_distance !== void 0 && (typeof config.soft_distance !== "number" || config.soft_distance < 0)) {
  ...
  public setBlockSensor(config: {
    ...
    if (config.sensor_radius !== void 0 &&
  ...
  public setBoostable(config: {
    ...
    if (config.duration !== void 0 && (typeof config.duration !== "number" || config.duration < 0)) {
      throw new TypeError("[set error]: boostable: duration must be a number >= 0");
    }
    if (config.speed_multiplier !== void 0 && (typeof config.speed_multiplier !== "number" || config.speed_multiplier <= 0)) {
  ...
  public setBoss(config: {
    ...
    if (config.hud_range !== void 0 && (typeof config.hud_range !== "number" || config.hud_range < 0)) {
    ...
    if (config.should_darken_sky !== void 0 && typeof config.should_darken_sky !== "boolean") {
  ...
  public setBribeable(config: {
    ...
    if (config.bribe_cooldown !== void 0 && (typeof config.bribe_cooldown !== "number" || config.bribe_cooldown < 0)) {
  ...
  public setBreedable(config: {
    ...
    if (config.breed_cooldown !== void 0 && (typeof config.breed_cooldown !== "number" || config.breed_cooldown < 0)) {
  ...
  public setBuoyant(config: {
    ...
    for (const prop of numberProperties) {
      ...
      if (prop === "big_wave_probability" && config.big_wave_probability !== void 0 &&
    ...
    if (config.movement_type !== void 0 &&
  ...
  public setBurnsInDaylight(config: {
    ...
    if (config.protection_slot !== void 0 && ![
  ...
  public setCelebrateHunt(config: {
    ...
    if (config.celebrate_sound !== void 0 && typeof config.celebrate_sound !== "string") {
  ...
  public setConditionalBandwidthOptimization(config: {
    ...
    if (config.conditional_values !== void 0) {
      ...
      for (let i = 0; i < config.conditional_values.length; i++) {
        ...
        if (item.max_dropped_ticks !== void 0 && typeof item.max_dropped_ticks !== "number") {
          throw new TypeError(`[set error]: conditional_bandwidth_optimization: conditional_values[${i}].max_dropped_ticks must be a number`);
        }
        if (item.max_optimized_distance !== void 0 && typeof item.max_optimized_distance !== "number") {
        ...
        if (item.use_motion_prediction_hints !== void 0 && typeof item.use_motion_prediction_hints !== "boolean") {
    ...
    if (config.default_values !== void 0) {
      ...
      if (config.default_values.max_dropped_ticks !== void 0 && typeof config.default_values.max_dropped_ticks !== "number") {
        throw new TypeError("[set error]: conditional_bandwidth_optimization: default_values.max_dropped_ticks must be a number");
      }
      if (config.default_values.max_optimized_distance !== void 0 && typeof config.default_values.max_optimized_distance !== "number") {
        throw new TypeError("[set error]: conditional_bandwidth_optimization: default_values.max_optimized_distance must be a number");
      }
      if (config.default_values.use_motion_prediction_hints !== void 0 && typeof config.default_values.use_motion_prediction_hints !== "boolean") {
  ...
  #validateDamageSensorTrigger(trigger: any): void {
    ...
    if (trigger.damage_modifier !== void 0 && typeof trigger.damage_modifier !== "number") {
      throw new TypeError("[set error]: damage_sensor: trigger.damage_modifier must be a number");
    }
    if (trigger.damage_multiplier !== void 0 && typeof trigger.damage_multiplier !== "number") {
    ...
    if (trigger.on_damage_sound_event !== void 0 && typeof trigger.on_damage_sound_event !== "string") {
  ...
  public setDash(config: {
    ...
    if (config.horizontal_momentum !== void 0 && typeof config.horizontal_momentum !== "number") {
      throw new TypeError("[set error]: dash: horizontal_momentum must be a number");
    }
    if (config.vertical_momentum !== void 0 && typeof config.vertical_momentum !== "number") {
  ...
  public setDashAction(config: {
    ...
    if (config.can_dash_underwater !== void 0 && typeof config.can_dash_underwater !== "boolean") {
  ...
  public setDryingOutTimer(config: {
    ...
    if (config.dried_out_event !== void 0) {
      ...
      if (typeof config.dried_out_event === "object" &&
        (config.dried_out_event.event === void 0 || typeof config.dried_out_event.event !== "string")) {
    ...
    if (config.recover_after_dried_out_event !== void 0) {
      ...
      if (typeof config.recover_after_dried_out_event === "object" &&
        (config.recover_after_dried_out_event.event === void 0 || typeof config.recover_after_dried_out_event.event !== "string")) {
    ...
    if (config.stopped_drying_out_event !== void 0) {
      ...
      if (typeof config.stopped_drying_out_event === "object" &&
        (config.stopped_drying_out_event.event === void 0 || typeof config.stopped_drying_out_event.event !== "string")) {
  ...
  public setDweller(config: {
    ...
    if (config.can_find_poi !== void 0 && typeof config.can_find_poi !== "boolean") {
      throw new TypeError("[set error]: dweller: can_find_poi must be a boolean");
    }

    if (config.can_migrate !== void 0 && typeof config.can_migrate !== "boolean") {
  ...
  public setEntitySensor(config: {
    ...
    if (config.find_players_only !== void 0 && typeof config.find_players_only !== "boolean") {
      throw new TypeError("[set error]: entity_sensor: find_players_only must be a boolean");
    }

    if (config.relative_range !== void 0 && typeof config.relative_range !== "boolean") {
    ...
    if (config.subsensors !== void 0) {
      ...
      for (let i = 0; i < config.subsensors.length; i++) {
        ...
        for (const prop of numericProperties) {
          if (subsensor && subsensor[prop] !== void 0 && typeof subsensor[prop] !== "number") {
        ...
        if (subsensor && subsensor.require_all !== void 0 && typeof subsensor.require_all !== "boolean") {
  ...
  public setEquipment(config: {
    ...
    if (config.slot_drop_chance !== void 0) {
      ...
      for (let i = 0; i < config.slot_drop_chance.length; i++) {
        ...
        if (typeof item === "object" && item.drop_chance !== void 0 &&
  ...
  public setEquippable(config: {
    ...
    if (config.slots !== void 0) {
      ...
      for (let i = 0; i < config.slots.length; i++) {
        ...
        if (slot.interact_text !== void 0 && typeof slot.interact_text !== "string") {
        ...
        if (slot.slot !== void 0 && (typeof slot.slot !== "number" || slot.slot < 0)) {
  ...
  public setEquipItem(config: {
    ...
    if (config.can_wear_armor !== void 0 && typeof config.can_wear_armor !== "boolean") {
    ...
    if (config.excluded_items !== void 0) {
      ...
      for (let i = 0; i < config.excluded_items.length; i++) {
        ...
        if (excludedItem.item !== void 0 && typeof excludedItem.item !== "string") {
  ...
  public setExhaustionValues(config: {
    ...
    for (const prop of numericProperties) {
      if (config[prop] !== void 0 && (typeof config[prop] !== "number" || config[prop] < 0)) {
  ...
  public setExperienceReward(config: {
    ...
    if (config.on_bred !== void 0) {
      if (typeof config.on_bred === "string" || typeof config.on_bred === "number") {
        ...
        if (config.on_bred.expression !== void 0 && typeof config.on_bred.expression !== "string") {
          throw new TypeError("[set error]: experience_reward: on_bred.expression must be a string");
        }
        if (config.on_bred.version !== void 0 && (typeof config.on_bred.version !== "number" || config.on_bred.version < 0)) {
    ...
    if (config.on_death !== void 0) {
      if (typeof config.on_death === "string" || typeof config.on_death === "number") {
        ...
        if (config.on_death.expression !== void 0 && typeof config.on_death.expression !== "string") {
          throw new TypeError("[set error]: experience_reward: on_death.expression must be a string");
        }
        if (config.on_death.version !== void 0 && (typeof config.on_death.version !== "number" || config.on_death.version < 0)) {
  ...
  public setExplode(config: {
    ...
    if (config.add?.component_groups !== void 0 && (!Array.isArray(config.add.component_groups) ||
    ...
    if (config.particle_effect !== void 0 &&
  ...
  public setFlocking(config: {
    ...
    const validateInteger = (value: any, name: string): void => {
      if (value !== void 0 && (typeof value !== "number" || !Number.isInteger(value))) {
    ...
    if (config.high_flock_limit !== void 0) validateInteger(config.high_flock_limit, "high_flock_limit");
    if (config.low_flock_limit !== void 0) validateInteger(config.low_flock_limit, "low_flock_limit");
  ...
  public setFollowRange(config: {
    ...
    if ((config.max !== void 0 && typeof config.max !== "number") ||
  ...
  public setFreeCameraControlled(config: {
    ...
    if ((config.backwards_movement_modifier !== void 0 && typeof config.backwards_movement_modifier !== "number") ||
      (config.strafe_speed_modifier !== void 0 && typeof config.strafe_speed_modifier !== "number")) {
  ...
  public setGameEventMovementTracking(config: {
    ...
    if ((config.emit_flap !== void 0 && typeof config.emit_flap !== "boolean") ||
  ...
  public setGenetics(config: {
    ...
    if (config.mutation_rate !== void 0 && (typeof config.mutation_rate !== "number" || config.mutation_rate < 0)) {
    ...
    if (config.genes !== void 0) {
      ...
      for (let i = 0; i < config.genes.length; i++) {
        ...
        if (gene.use_simplified_breeding !== void 0 && typeof gene.use_simplified_breeding !== "boolean") {
          throw new TypeError(`[set error]: genetics: genes[${i}].use_simplified_breeding must be a boolean`);
        }

        // Validate gene mutation_rate
        if (gene.mutation_rate !== void 0 && (typeof gene.mutation_rate !== "number" || gene.mutation_rate < -1)) {
  ...
  public setGiveable(config: {
    ...
    // Validate cooldown
    if (config.cooldown !== void 0 && (typeof config.cooldown !== "number" || config.cooldown < 0)) {
  ...
  public setGroupSize(config: {
    ...
    // Validate radius
    if (config.radius !== void 0 && (typeof config.radius !== "number" || config.radius < 0)) {
    ...
    if (config.filters !== void 0 && (typeof config.filters !== "object" || config.filters === null)) {
  ...
  public setGrowsCrop(config: {
    ...
    // Validate chance (0-1)
    if (config.chance !== void 0 && (typeof config.chance !== "number" || config.chance < 0 || config.chance > 1)) {
      throw new TypeError("[set error]: grows_crop: chance must be a number between 0 and 1");
    }

    // Validate charges (must be integer >= 1)
    if (config.charges !== void 0 && (typeof config.charges !== "number" || !Number.isInteger(config.charges) || config.charges < 1)) {
  ...
  public setHealth(config: {
    ...
    if (config.max !== void 0 && (typeof config.max !== "number" || !Number.isInteger(config.max) || config.max < 1)) {
    ...
    // Validate value as object
    else if (config.value !== void 0 && typeof config.value === "object" && config.value !== null) {
      if (config.value.range_min !== void 0 &&
      ...
      if (config.value.range_max !== void 0 &&
      ...
      if (config.value.range_min !== void 0 && config.value.range_max !== void 0 &&
    ...
    else if (config.value !== void 0 && typeof config.value !== "number" &&
  ...
  public setHeartbeat(config: {
    ...
    if (config.sound_event !== void 0 && typeof config.sound_event !== "string") {
  ...
  public setHome(config: {
    ...
    if (config.restriction_radius !== void 0 &&
    ...
    if (config.restriction_type !== void 0 &&
  ...
  public setHurtOnCondition(config: {
    ...
    if (config.damage_conditions !== void 0) {
      ...
      for (let i = 0; i < config.damage_conditions.length; i++) {
        ...
        if (condition.damage_per_tick !== void 0 &&
  ...
  public setIgnoreCannotBeAttacked(config: {
    ...
    if (config.filters?.subject !== void 0 && typeof config.filters.subject !== "string") {
    ...
    if (config.filters?.test !== void 0 && typeof config.filters.test !== "string") {
    ...
    if (config.filters?.operator !== void 0 && typeof config.filters.operator !== "string") {
  ...
  public setInsideBlockNotifier(config: {
    ...
    if (config.block_list !== void 0) {
      ...
      for (let i = 0; i < config.block_list.length; i++) {
        ...
        if (blockEntry.block?.name !== void 0 && typeof blockEntry.block.name !== "string") {
        ...
        if (blockEntry.block?.states !== void 0 &&
        ...
        if (blockEntry.entered_block_event !== void 0 &&
        ...
        if (blockEntry.entered_block_event?.event !== void 0 && typeof blockEntry.entered_block_event.event !== "string") {
        ...
        if (blockEntry.entered_block_event?.target !== void 0 && typeof blockEntry.entered_block_event.target !== "string") {
        ...
        if (blockEntry.exited_block_event !== void 0 &&
        ...
        if (blockEntry.exited_block_event?.event !== void 0 && typeof blockEntry.exited_block_event.event !== "string") {
        ...
        if (blockEntry.exited_block_event?.target !== void 0 && typeof blockEntry.exited_block_event.target !== "string") {
  ...
  public setInsomnia(config: {
    ...
    if (config.days_until_insomnia !== void 0 &&
  ...
  public setInstantDespawn(config: {
    ...
    if (config.remove_child_entities !== void 0 &&
  ...
  public setInteract(config: {
    ...
    if (config.drop_item_y_offset !== void 0 &&
    ...
    if (config.health_amount !== void 0 &&
    ...
    if (config.interact_text !== void 0 &&
    ...
    if (config.interactions !== void 0) {
      ...
      for (let i = 0; i < config.interactions.length; i++) {
        ...
        if (interaction.give_item !== void 0 &&
        ...
        if (interaction.on_interact !== void 0 &&
        ...
        if (interaction.particle_on_start !== void 0) {
          ...
          for (let j = 0; j < interaction.particle_on_start.length; j++) {
            ...
            if (particle.particle_offset_towards_interactor !== void 0 &&
            ...
            if (particle.particle_type !== void 0 &&
            ...
            if (particle.particle_y_offset !== void 0 &&
        ...
        if (interaction.play_sounds !== void 0 &&
        ...
        if (interaction.spawn_entities !== void 0 &&
        ...
        if (interaction.take_item !== void 0 &&
        ...
        if (interaction.transform_to_item !== void 0 &&
        ...
        if (interaction.use_item !== void 0 &&
        ...
        if (interaction.vibration !== void 0 &&
  ...
  public setInventory(config: {
    ...
    if (config.additional_slots_per_strength !== void 0 &&
    ...
    if (config.can_be_siphoned_from !== void 0 &&
    ...
    if (config.container_type !== void 0 &&
    ...
    if (config.inventory_size !== void 0 &&
    ...
    if (config.restrict_to_owner !== void 0 &&
  ...
  public setItemControllable(config: {
    control_items?: string | string[]
  } = {}): void {
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: item_controllable: must be an object configuration");
    }

    // Validate control_items (string or string array if provided)
    if (config.control_items !== void 0) {
      if (typeof config.control_items !== "string" &&
        (!Array.isArray(config.control_items) || config.control_items.some((item: any) => typeof item !== "string"))) {
        throw new TypeError("[set error]: item_controllable: control_items must be a string or array of strings");
      }
    }
  ...
  public setLeashable(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: leashable: must be an object configuration");
    }

    // Validate boolean values
    if (config.can_be_cut !== void 0 && typeof config.can_be_cut !== "boolean") {
      throw new TypeError("[set error]: leashable: can_be_cut must be boolean");
    }
    if (config.can_be_stolen !== void 0 && typeof config.can_be_stolen !== "boolean") {
      throw new TypeError("[set error]: leashable: can_be_stolen must be boolean");
    }

    // Validate number values
    if (config.hard_distance !== void 0 && typeof config.hard_distance !== "number") {
      throw new TypeError("[set error]: leashable: hard_distance must be a number");
    }
    if (config.max_distance !== void 0 && typeof config.max_distance !== "number") {
      throw new TypeError("[set error]: leashable: max_distance must be a number");
    }
    if (config.soft_distance !== void 0 && typeof config.soft_distance !== "number") {
      throw new TypeError("[set error]: leashable: soft_distance must be a number");
    }

    // Validate event handlers
    if (config.on_leash !== void 0) {
      if (typeof config.on_leash !== "string" &&
        (typeof config.on_leash !== "object" || config.on_leash === null || !("event" in config.on_leash))) {
        throw new TypeError("[set error]: leashable: on_leash must be string or object with event property");
      }
    }
    if (config.on_unleash !== void 0) {
      if (typeof config.on_unleash !== "string" &&
        (typeof config.on_unleash !== "object" || config.on_unleash === null || !("event" in config.on_unleash))) {
        throw new TypeError("[set error]: leashable: on_unleash must be string or object with event property");
      }
    }
    ...
    if (config.presets !== void 0) {
      ...
      for (const preset of config.presets) {
        if (typeof preset !== "object" || preset === null) {
          throw new TypeError("[set error]: leashable: presets must contain objects");
        }

        if (preset.spring_type !== void 0 && !["bouncy", "dampened", "quad_dampened"].includes(preset.spring_type)) {
          throw new TypeError("[set error]: leashable: spring_type must be one of 'bouncy', 'dampened', or 'quad_dampened'");
        }
      }
    }
   ...
   */
  public setLeashableTo(config: {
    can_retrieve_from?: boolean
  } = {}): void {
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: leashable_to: must be an object configuration");
    }

    // Validate can_retrieve_from
    if (config.can_retrieve_from !== void 0 && typeof config.can_retrieve_from !== "boolean") {
      throw new TypeError("[set error]: leashable_to: can_retrieve_from must be boolean");
    }
  ...
  public setLookedAt(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: looked_at: must be an object configuration");
    }

    // Validate field_of_view
    if (config.field_of_view !== void 0 && typeof config.field_of_view !== "number") {
      throw new TypeError("[set error]: looked_at: field_of_view must be a number");
    }

    // Validate find_players_only
    if (config.find_players_only !== void 0 && typeof config.find_players_only !== "boolean") {
      throw new TypeError("[set error]: looked_at: find_players_only must be boolean");
    }

    // Validate line_of_sight_obstruction_type
    if (config.line_of_sight_obstruction_type !== void 0 &&
      !["outline", "collision", "collision_for_camera"].includes(config.line_of_sight_obstruction_type)) {
      throw new TypeError("[set error]: looked_at: line_of_sight_obstruction_type must be 'outline', 'collision', or 'collision_for_camera'");
    }

    // Validate look_at_locations
    if (config.look_at_locations !== void 0) {
      if (!Array.isArray(config.look_at_locations) ||
        config.look_at_locations.some((loc: any) => typeof loc !== "string")) {
        throw new TypeError("[set error]: looked_at: look_at_locations must be an array of strings");
      }
    }

    // Validate looked_at_cooldown
    if (config.looked_at_cooldown !== void 0) {
      if (typeof config.looked_at_cooldown !== "object" || config.looked_at_cooldown === null ||
        typeof config.looked_at_cooldown.min !== "number" || typeof config.looked_at_cooldown.max !== "number") {
        throw new TypeError("[set error]: looked_at: looked_at_cooldown must be an object with min and max numbers");
      }
    }

    // Validate looked_at_event
    if (config.looked_at_event !== void 0) {
      if (typeof config.looked_at_event !== "string" &&
        (typeof config.looked_at_event !== "object" || config.looked_at_event === null || !("event" in config.looked_at_event))) {
        throw new TypeError("[set error]: looked_at: looked_at_event must be string or object with event property");
      }
    }

    // Validate min_looked_at_duration
    if (config.min_looked_at_duration !== void 0 && typeof config.min_looked_at_duration !== "number") {
      throw new TypeError("[set error]: looked_at: min_looked_at_duration must be a number");
    }

    // Validate not_looked_at_event
    if (config.not_looked_at_event !== void 0) {
      if (typeof config.not_looked_at_event !== "string" &&
        (typeof config.not_looked_at_event !== "object" || config.not_looked_at_event === null || !("event" in config.not_looked_at_event))) {
        throw new TypeError("[set error]: looked_at: not_looked_at_event must be string or object with event property");
      }
    }

    // Validate scale_fov_by_distance
    if (config.scale_fov_by_distance !== void 0 && typeof config.scale_fov_by_distance !== "boolean") {
      throw new TypeError("[set error]: looked_at: scale_fov_by_distance must be boolean");
    }

    // Validate search_radius
    if (config.search_radius !== void 0 && typeof config.search_radius !== "number") {
      throw new TypeError("[set error]: looked_at: search_radius must be a number");
    }

    // Validate set_target
    if (config.set_target !== void 0) {
      if (typeof config.set_target !== "boolean" && config.set_target !== "never" &&
        config.set_target !== "once_and_stop_scanning" && config.set_target !== "once_and_keep_scanning") {
        throw new TypeError("[set error]: looked_at: set_target must be boolean, 'never', 'once_and_stop_scanning', or 'once_and_keep_scanning'");
      }
    }
  ...
  public setMarkVariant(value: number): void {
    if (typeof value !== "number" || !Number.isInteger(value) || value < 0) {
      throw new TypeError("[set error]: mark_variant: value must be a non-negative integer");
    }
  ...
  public setMobEffect(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: mob_effect: must be an object configuration");
    }

    // Validate required mob_effect property
    if (typeof config.mob_effect !== "string" || config.mob_effect.trim() === "") {
      throw new TypeError("[set error]: mob_effect: mob_effect must be a non-empty string");
    }
    ...
    if (config.cooldown_time !== void 0) {
      if (typeof config.cooldown_time !== "number" || config.cooldown_time < 0) {
        throw new TypeError("[set error]: mob_effect: cooldown_time must be a non-negative number");
      }
    }
    ...
    if (config.effect_range !== void 0) {
      if (typeof config.effect_range !== "number" || config.effect_range <= 0) {
        throw new TypeError("[set error]: mob_effect: effect_range must be a positive number");
      }
    }
    ...
    if (config.effect_time !== void 0) {
      if (config.effect_time === "infinite") {
        // Valid case
      } else if (typeof config.effect_time !== "number" || config.effect_time <= 0) {
        throw new TypeError("[set error]: mob_effect: effect_time must be 'infinite' or a positive number");
      }
    }

    // Validate entity_filter (if provided)
    if (config.entity_filter !== void 0) {
      if (typeof config.entity_filter !== "object" || config.entity_filter === null) {
        throw new TypeError("[set error]: mob_effect: entity_filter must be an object");
      }
    }
  ...
  public setMobEffectImmunity(mob_effects: string[]): void {
    if (!Array.isArray(mob_effects)) {
      throw new TypeError("[set error]: mob_effect_immunity: mob_effects must be an array");
    }

    // Validate each mob effect name
    for (const effect of mob_effects) {
      if (typeof effect !== "string" || effect.trim() === "") {
        throw new TypeError("[set error]: mob_effect_immunity: each mob effect must be a non-empty string");
      }
    }
   ...
   */
  public setMovement(config: {
    max?: number
    value?: number | { range_min: number, range_max: number }
  } = {}): void {
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: movement: must be an object configuration");
    }

    // Validate max
    if (config.max !== void 0 && (typeof config.max !== "number" || config.max <= 0)) {
      throw new TypeError("[set error]: movement: max must be a positive number");
    }
    ...
    if (config.value !== void 0) {
      if (typeof config.value === "number") {
        if (config.value <= 0) {
          throw new TypeError("[set error]: movement: value must be a positive number when provided as number");
        }
      } else if (typeof config.value === "object" && config.value !== null) {
        if (typeof config.value.range_min !== "number" || config.value.range_min < 0) {
          throw new TypeError("[set error]: movement: value.range_min must be a non-negative number");
        }
        if (typeof config.value.range_max !== "number" || config.value.range_max <= 0) {
          throw new TypeError("[set error]: movement: value.range_max must be a positive number");
        }
        if (config.value.range_min >= config.value.range_max) {
          throw new TypeError("[set error]: movement: value.range_min must be less than value.range_max");
        }
      } else {
        throw new TypeError("[set error]: movement: value must be a number or object with range_min and range_max");
      }
    }
  ...
  public setMovementAmphibious(max_turn?: number): void {
    ...
    if (max_turn !== void 0) {
      if (typeof max_turn !== "number" || max_turn <= 0) {
        throw new TypeError("[set error]: movement.amphibious: max_turn must be a positive number");
      }
  ...
  public setMovementBasic(max_turn?: number): void {
    ...
    if (max_turn !== void 0) {
      if (typeof max_turn !== "number" || max_turn <= 0) {
        throw new TypeError("[set error]: movement.basic: max_turn must be a positive number");
      }
      config.max_turn = max_turn;
    }
   ...
   */
  public setMovementFly(config: {
    max_turn?: number
    speed_when_turning?: number
    start_speed?: number
  } = {}): void {
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: movement.fly: must be an object configuration");
    }

    // Validate max_turn
    if (config.max_turn !== void 0 && (typeof config.max_turn !== "number" || config.max_turn <= 0)) {
      throw new TypeError("[set error]: movement.fly: max_turn must be a positive number");
    }

    // Validate speed_when_turning
    if (config.speed_when_turning !== void 0 && (typeof config.speed_when_turning !== "number" || config.speed_when_turning <= 0)) {
      throw new TypeError("[set error]: movement.fly: speed_when_turning must be a positive number");
    }

    // Validate start_speed
    if (config.start_speed !== void 0 && (typeof config.start_speed !== "number" || config.start_speed <= 0)) {
      throw new TypeError("[set error]: movement.fly: start_speed must be a positive number");
    }
  ...
  public setMovementGeneric(max_turn?: number): void {
    ...
    if (max_turn !== void 0) {
      if (typeof max_turn !== "number" || max_turn <= 0) {
        throw new TypeError("[set error]: movement.generic: max_turn must be a positive number");
      }
      config.max_turn = max_turn;
    }
   ...
   */
  public setMovementGlide(config: {
    max_turn?: number
    speed_when_turning?: number
  } = {}): void {
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: movement.glide: must be an object configuration");
    }

    // Validate max_turn
    if (config.max_turn !== void 0 && (typeof config.max_turn !== "number" || config.max_turn <= 0)) {
      throw new TypeError("[set error]: movement.glide: max_turn must be a positive number");
    }

    // Validate speed_when_turning
    if (config.speed_when_turning !== void 0 && (typeof config.speed_when_turning !== "number" || config.speed_when_turning <= 0)) {
      throw new TypeError("[set error]: movement.glide: speed_when_turning must be a positive number");
    }
  ...
  public setMovementHover(max_turn?: number): void {
    ...
    if (max_turn !== void 0) {
      if (typeof max_turn !== "number" || max_turn <= 0) {
        throw new TypeError("[set error]: movement.hover: max_turn must be a positive number");
      }
      config.max_turn = max_turn;
    }
   ...
   */
  public setMovementJump(config: {
    jump_delay?: number | [number, number] | { range_min: number, range_max: number }
    max_turn?: number
  } = {}): void {
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: movement.jump: must be an object configuration");
    }
    ...
    if (config.jump_delay !== void 0) {
      if (typeof config.jump_delay === "number") {
        if (config.jump_delay < 0) {
          throw new TypeError("[set error]: movement.jump: jump_delay must be a non-negative number when provided as number");
        }
      } else if (Array.isArray(config.jump_delay) && config.jump_delay.length === 2) {
        if (typeof config.jump_delay[0] !== "number" || config.jump_delay[0] < 0) {
          throw new TypeError("[set error]: movement.jump: jump_delay[0] must be a non-negative number");
        }
        if (typeof config.jump_delay[1] !== "number" || config.jump_delay[1] <= 0) {
          throw new TypeError("[set error]: movement.jump: jump_delay[1] must be a positive number");
        }
        if (config.jump_delay[0] >= config.jump_delay[1]) {
          throw new TypeError("[set error]: movement.jump: jump_delay[0] must be less than jump_delay[1]");
        }
      } else if (typeof config.jump_delay === "object" && config.jump_delay !== null && 'range_min' in config.jump_delay) {
        const jumpDelay = config.jump_delay as { range_min?: number, range_max?: number };
        if (typeof jumpDelay.range_min !== "number" || jumpDelay.range_min < 0) {
          throw new TypeError("[set error]: movement.jump: jump_delay.range_min must be a non-negative number");
        }
        if (typeof jumpDelay.range_max !== "number" || jumpDelay.range_max <= 0) {
          throw new TypeError("[set error]: movement.jump: jump_delay.range_max must be a positive number");
        }
        if (jumpDelay.range_min >= jumpDelay.range_max) {
          throw new TypeError("[set error]: movement.jump: jump_delay.range_min must be less than jump_delay.range_max");
        }
      } else {
        throw new TypeError("[set error]: movement.jump: jump_delay must be number, array [min, max], or object with range_min and range_max");
      }
    }

    // Validate max_turn
    if (config.max_turn !== void 0 && (typeof config.max_turn !== "number" || config.max_turn <= 0)) {
      throw new TypeError("[set error]: movement.jump: max_turn must be a positive number");
    }
  ...
  public setMovementSkip(max_turn?: number): void {
    ...
    if (max_turn !== void 0) {
      if (typeof max_turn !== "number" || max_turn <= 0) {
        throw new TypeError("[set error]: movement.skip: max_turn must be a positive number");
      }
      config.max_turn = max_turn;
    }
  ...
  public setMovementSoundDistanceOffset(value?: number): void {
    ...
    if (value !== void 0) {
      if (typeof value !== "number" || value <= 0) {
        throw new TypeError("[set error]: movement.sound_distance_offset: value must be a positive number");
      }
      config.value = value;
    }
   ...
   */
  public setMovementSway(config: {
    max_turn?: number
    sway_amplitude?: number
    sway_frequency?: number
  } = {}): void {
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: movement.sway: must be an object configuration");
    }

    // Validate max_turn
    if (config.max_turn !== void 0 && (typeof config.max_turn !== "number" || config.max_turn <= 0)) {
      throw new TypeError("[set error]: movement.sway: max_turn must be a positive number");
    }

    // Validate sway_amplitude
    if (config.sway_amplitude !== void 0 && (typeof config.sway_amplitude !== "number" || config.sway_amplitude <= 0)) {
      throw new TypeError("[set error]: movement.sway: sway_amplitude must be a positive number");
    }

    // Validate sway_frequency
    if (config.sway_frequency !== void 0 && (typeof config.sway_frequency !== "number" || config.sway_frequency <= 0)) {
      throw new TypeError("[set error]: movement.sway: sway_frequency must be a positive number");
    }
  ...
  public setNameable(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: nameable: must be an object configuration");
    }

    // Validate allow_name_tag_renaming
    if (config.allow_name_tag_renaming !== void 0 && typeof config.allow_name_tag_renaming !== "boolean") {
      throw new TypeError("[set error]: nameable: allow_name_tag_renaming must be boolean");
    }

    // Validate always_show
    if (config.always_show !== void 0 && typeof config.always_show !== "boolean") {
      throw new TypeError("[set error]: nameable: always_show must be boolean");
    }

    // Validate default_trigger
    if (config.default_trigger !== void 0 && (typeof config.default_trigger !== "string" || config.default_trigger.trim() === "")) {
      throw new TypeError("[set error]: nameable: default_trigger must be a non-empty string");
    }

    // Validate name_actions
    if (config.name_actions !== void 0) {
      if (!Array.isArray(config.name_actions)) {
        throw new TypeError("[set error]: nameable: name_actions must be an array");
      }

      for (const action of config.name_actions) {
        if (typeof action !== "object" || action === null) {
          throw new TypeError("[set error]: nameable: each name_action must be an object");
        }

        // Validate name_filter
        if (action.name_filter !== void 0) {
          if (!Array.isArray(action.name_filter)) {
            throw new TypeError("[set error]: nameable: name_action.name_filter must be an array");
          }
          for (const filter of action.name_filter) {
            if (typeof filter !== "string" || filter.trim() === "") {
              throw new TypeError("[set error]: nameable: each name_filter item must be a non-empty string");
            }
          }
        }
        ...
        if (action.on_named !== void 0) {
          if (typeof action.on_named !== "string" &&
            (typeof action.on_named !== "object" || action.on_named === null || !("event" in action.on_named))) {
            throw new TypeError("[set error]: nameable: name_action.on_named must be string or object with event property");
          }
        }
      }
    }
   ...
   */
  public setNavigationClimb(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: navigation.climb: must be an object configuration");
    }

    // Validate boolean properties
    const booleanProps = [
      'avoid_damage_blocks', 'avoid_portals', 'avoid_sun', 'avoid_water',
      'can_breach', 'can_break_doors', 'can_jump', 'can_open_doors',
      'can_open_iron_doors', 'can_pass_doors', 'can_path_from_air',
      'can_path_over_lava', 'can_path_over_water', 'can_sink', 'can_swim',
      'can_walk', 'can_walk_in_lava', 'is_amphibious'
    ];

    for (const prop of booleanProps) {
      if (config[prop as keyof typeof config] !== void 0 &&
        typeof config[prop as keyof typeof config] !== "boolean") {
        throw new TypeError(`[set error]: navigation.climb: ${prop} must be boolean`);
      }
    }
    ...
    if (config.blocks_to_avoid !== void 0) {
      if (!Array.isArray(config.blocks_to_avoid)) {
        throw new TypeError("[set error]: navigation.climb: blocks_to_avoid must be an array");
      }
      for (const block of config.blocks_to_avoid) {
        if (typeof block !== "string" || block.trim() === "") {
          throw new TypeError("[set error]: navigation.climb: each block in blocks_to_avoid must be a non-empty string");
        }
      }
    }
  ...
  public setNavigationFloat(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: navigation.float: must be an object configuration");
    }
    ...
    const booleanProps = [
      ...
      'can_breach', 'can_break_doors', 'can_jump', 'can_open_doors',
      'can_open_iron_doors', 'can_pass_doors', 'can_path_from_air',
      'can_path_over_water', 'can_sink', 'can_swim', 'can_walk',
      'can_walk_in_lava', 'is_amphibious', 'using_door_annotation'
    ];

    for (const prop of booleanProps) {
      if (config[prop as keyof typeof config] !== void 0 && typeof config[prop as keyof typeof config] !== "boolean") {
        throw new TypeError(`[set error]: navigation.float: ${prop} must be boolean`);
      }
    }
    ...
    if (config.blocks_to_avoid !== void 0) {
      if (!Array.isArray(config.blocks_to_avoid)) {
        throw new TypeError("[set error]: navigation.float: blocks_to_avoid must be an array");
      }
      for (const block of config.blocks_to_avoid) {
        if (typeof block !== "string" || block.trim() === "") {
          throw new TypeError("[set error]: navigation.float: each block in blocks_to_avoid must be a non-empty string");
        }
      }
    }
  ...
  public setNavigationFly(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: navigation.fly: must be an object configuration");
    }
    ...
    for (const prop of booleanProps) {
      if (config[prop as keyof typeof config] !== void 0 && typeof config[prop as keyof typeof config] !== "boolean") {
        throw new TypeError(`[set error]: navigation.fly: ${prop} must be boolean`);
      }
    }
    ...
    if (config.blocks_to_avoid !== void 0) {
      if (!Array.isArray(config.blocks_to_avoid)) {
        throw new TypeError("[set error]: navigation.fly: blocks_to_avoid must be an array");
      }
      for (const block of config.blocks_to_avoid) {
        if (typeof block !== "string" || block.trim() === "") {
          throw new TypeError("[set error]: navigation.fly: each block in blocks_to_avoid must be a non-empty string");
        }
      }
    }
  ...
  public setNavigationGeneric(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: navigation.generic: must be an object configuration");
    }
    ...
    for (const prop of booleanProps) {
      if (config[prop as keyof typeof config] !== void 0 && typeof config[prop as keyof typeof config] !== "boolean") {
        throw new TypeError(`[set error]: navigation.generic: ${prop} must be boolean`);
      }
    }
    ...
    if (config.blocks_to_avoid !== void 0) {
      if (!Array.isArray(config.blocks_to_avoid)) {
        throw new TypeError("[set error]: navigation.generic: blocks_to_avoid must be an array");
      }
      for (const block of config.blocks_to_avoid) {
        if (typeof block !== "string" || block.trim() === "") {
          throw new TypeError("[set error]: navigation.generic: each block in blocks_to_avoid must be a non-empty string");
        }
      }
    }
  ...
  public setNavigationHover(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: navigation.hover: must be an object configuration");
    }
    ...
    for (const prop of booleanProps) {
      if (config[prop as keyof typeof config] !== void 0 && typeof config[prop as keyof typeof config] !== "boolean") {
        throw new TypeError(`[set error]: navigation.hover: ${prop} must be boolean`);
      }
    }
    ...
    if (config.blocks_to_avoid !== void 0) {
      if (!Array.isArray(config.blocks_to_avoid)) {
        throw new TypeError("[set error]: navigation.hover: blocks_to_avoid must be an array");
      }
      for (const block of config.blocks_to_avoid) {
        if (typeof block !== "string" || block.trim() === "") {
          throw new TypeError("[set error]: navigation.hover: each block in blocks_to_avoid must be a non-empty string");
        }
      }
    }
  ...
  public setNavigationSwim(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: navigation.swim: must be an object configuration");
    }
    ...
    for (const prop of booleanProps) {
      if (config[prop as keyof typeof config] !== void 0 && typeof config[prop as keyof typeof config] !== "boolean") {
        throw new TypeError(`[set error]: navigation.swim: ${prop} must be boolean`);
      }
    }
    ...
    if (config.blocks_to_avoid !== void 0) {
      if (!Array.isArray(config.blocks_to_avoid)) {
        throw new TypeError("[set error]: navigation.swim: blocks_to_avoid must be an array");
      }
      for (const block of config.blocks_to_avoid) {
        if (typeof block === "string") {
          if (block.trim() === "") {
            throw new TypeError("[set error]: navigation.swim: each block string in blocks_to_avoid must be non-empty");
          }
        } else if (typeof block === "object" && block !== null) {
          if (block.name !== void 0 && typeof block.name !== "string") {
            throw new TypeError("[set error]: navigation.swim: block.name must be a string");
          }
          if (block.tags !== void 0 && typeof block.tags !== "string") {
            throw new TypeError("[set error]: navigation.swim: block.tags must be a string");
          }
        } else {
          throw new TypeError("[set error]: navigation.swim: each block in blocks_to_avoid must be a string or object");
        }
      }
    }
  ...
  public setNavigationWalk(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: navigation.walk: must be an object configuration");
    }

    // Validate boolean properties
    const booleanProps = [
      'avoid_damage_blocks', 'avoid_portals', 'avoid_sun', 'avoid_water',
      'can_breach', 'can_break_doors', 'can_float', 'can_jump', 'can_open_doors',
      'can_open_iron_doors', 'can_pass_doors', 'can_path_from_air',
      'can_path_over_lava', 'can_path_over_water', 'can_sink', 'can_swim',
      'can_walk', 'can_walk_in_lava', 'is_amphibious', 'using_door_annotation'
    ];

    for (const prop of booleanProps) {
      if (config[prop as keyof typeof config] !== void 0 && typeof config[prop as keyof typeof config] !== "boolean") {
        throw new TypeError(`[set error]: navigation.walk: ${prop} must be boolean`);
      }
    }
    ...
    if (config.blocks_to_avoid !== void 0) {
      if (!Array.isArray(config.blocks_to_avoid)) {
        throw new TypeError("[set error]: navigation.walk: blocks_to_avoid must be an array");
      }
      for (const block of config.blocks_to_avoid) {
        if (typeof block === "string") {
          if (block.trim() === "") {
            throw new TypeError("[set error]: navigation.walk: each block string in blocks_to_avoid must be non-empty");
          }
        } else if (typeof block === "object" && block !== null) {
          if (block.name !== void 0 && typeof block.name !== "string") {
            throw new TypeError("[set error]: navigation.walk: block.name must be a string");
          }
          if (block.tags !== void 0 && typeof block.tags !== "string") {
            throw new TypeError("[set error]: navigation.walk: block.tags must be a string");
          }
        } else {
          throw new TypeError("[set error]: navigation.walk: each block in blocks_to_avoid must be a string or object");
        }
      }
    }
  ...
  public setPhysics(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: physics: must be an object configuration");
    }

    // Validate boolean properties
    if (config.has_collision !== void 0 && typeof config.has_collision !== "boolean") {
      throw new TypeError("[set error]: physics: has_collision must be boolean");
    }
    if (config.has_gravity !== void 0 && typeof config.has_gravity !== "boolean") {
      throw new TypeError("[set error]: physics: has_gravity must be boolean");
    }
    if (config.push_towards_closest_space !== void 0 && typeof config.push_towards_closest_space !== "boolean") {
      throw new TypeError("[set error]: physics: push_towards_closest_space must be boolean");
    }
  ...
  public setPlayerExhaustion(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: player.exhaustion: must be an object configuration");
    }

    // Validate numeric properties
    if (config.max !== void 0 && (typeof config.max !== "number" || config.max < 0)) {
      throw new TypeError("[set error]: player.exhaustion: max must be a non-negative number");
    }
    if (config.value !== void 0 && (typeof config.value !== "number" || config.value < 0)) {
      throw new TypeError("[set error]: player.exhaustion: value must be a non-negative number");
    }
  ...
  public setOffspring(config: {
    ...
    if (typeof config !== "object" || config === null) {
      throw new TypeError("[set error]: offspring: must be an object configuration");
    }

    // Validate boolean properties
    if (config.blend_attributes !== void 0 && typeof config.blend_attributes !== "boolean") {
      throw new TypeError("[set error]: offspring: blend_attributes must be boolean");
    }
    if (config.inherit_tamed !== void 0 && typeof config.inherit_tamed !== "boolean") {
      throw new TypeError("[set error]: offspring: inherit_tamed must be boolean");
    }

    // Validate deny_parents_variant array
    if (config.deny_parents_variant !== void 0) {
      if (!Array.isArray(config.deny_parents_variant)) {
        throw new TypeError("[set error]: offspring: deny_parents_variant must be an array");
      }
      for (const item of config.deny_parents_variant) {
        if (item.chance !== void 0 && (typeof item.chance !== "number" || item.chance < 0)) {
          throw new TypeError("[set error]: offspring: deny_parents_variant.chance must be a non-negative number");
        }
        if (item.max_variant !== void 0 && (typeof item.max_variant !== "number" || item.max_variant < 0)) {
          throw new TypeError("[set error]: offspring: deny_parents_variant.max_variant must be a non-negative integer");
        }
        if (item.min_variant !== void 0 && (typeof item.min_variant !== "number" || item.min_variant < 0)) {
          throw new TypeError("[set error]: offspring: deny_parents_variant.min_variant must be a non-negative integer");
        }
      }
    }
    ...
    if (config.mutation_factor !== void 0) {
      if (config.mutation_factor.color !== void 0 && (typeof config.mutation_factor.color !== "number" || config.mutation_factor.color < 0 || config.mutation_factor.color > 1)) {
        throw new TypeError("[set error]: offspring: mutation_factor.color must be a number between 0.0 and 1.0");
      }
      if (config.mutation_factor.extra_variant !== void 0 && (typeof config.mutation_factor.extra_variant !== "number" || config.mutation_factor.extra_variant < 0 || config.mutation_factor.extra_variant > 1)) {
        throw new TypeError("[set error]: offspring: mutation_factor.extra_variant must be a number between 0.0 and 1.0");
      }
      if (config.mutation_factor.variant !== void 0 && (typeof config.mutation_factor.variant !== "number" || config.mutation_factor.variant < 0 || config.mutation_factor.variant > 1)) {
        throw new TypeError("[set error]: offspring: mutation_factor.variant must be a number between 0.0 and 1.0");
      }
    }

    // Validate parent_centric_attribute_blending
    if (config.parent_centric_attribute_blending !== void 0) {
      if (typeof config.parent_centric_attribute_blending !== "object" || config.parent_centric_attribute_blending === null) {
        throw new TypeError("[set error]: offspring: parent_centric_attribute_blending must be an object");
      }
      const item = config.parent_centric_attribute_blending;
      if (item.attribute !== void 0 && typeof item.attribute !== "string") {
        throw new TypeError("[set error]: offspring: parent_centric_attribute_blending attribute must be string");
      }
      if (item.dampening !== void 0 && typeof item.dampening !== "number") {
        throw new TypeError("[set error]: offspring: parent_centric_attribute_blending dampening must be number");
      }
    }

    // Validate random intervals
    if (config.random_extra_variant_mutation_interval !== void 0) {
      if (config.random_extra_variant_mutation_interval.range_max !== void 0 && (typeof config.random_extra_variant_mutation_interval.range_max !== "number" || config.random_extra_variant_mutation_interval.range_max < 0)) {
        throw new TypeError("[set error]: offspring: random_extra_variant_mutation_interval.range_max must be a non-negative number");
      }
      if (config.random_extra_variant_mutation_interval.range_min !== void 0 && (typeof config.random_extra_variant_mutation_interval.range_min !== "number" || config.random_extra_variant_mutation_interval.range_min < 0)) {
        throw new TypeError("[set error]: offspring: random_extra_variant_mutation_interval.range_min must be a non-negative number");
      }
    }
    if (config.random_variant_mutation_interval !== void 0) {
      if (config.random_variant_mutation_interval.range_max !== void 0 && (typeof config.random_variant_mutation_interval.range_max !== "number" || config.random_variant_mutation_interval.range_max < 0)) {
        throw new TypeError("[set error]: offspring: random_variant_mutation_interval.range_max must be a non-negative number");
      }
      if (config.random_variant_mutation_interval.range_min !== void 0 && (typeof config.random_variant_mutation_interval.range_min !== "number" || config.random_variant_mutation_interval.range_min < 0)) {
        throw new TypeError("[set error]: offspring: random_variant_mutation_interval.range_min must be a non-negative number");
      }
    }
    if (!this.#opt.components) {
      this.#opt.components = {};
